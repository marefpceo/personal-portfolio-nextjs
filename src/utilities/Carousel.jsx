  ...
  return (
    <div className='carousel-container overflow-hidden w-full h-full relative'>
      <div className='carousel-wrapper flex h-4/6 relative'>
        <div
          ref={carouselRef}
          className='carousel-content-wrapper overflow-hidden w-full'
        >
          <div
      ...
      <div className='mt-12 h-1/4 items-center justify-center flex gap-16'>
        <button
          onClick={prevSlide}
          className='left-arrow w-16 p-2.5 z-50 rounded-4xl bg-nature-dark 
        ...
        <button
          onClick={nextSlide}
          className='right-arrow w-16 p-2.5 z-50 rounded-4xl bg-nature-dark
          border  border-nature-light/50 text-nature-accent shadow-[0_0_8px_0] 
          shadow-nature-accent'
        >
          &#10095;
