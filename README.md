...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin marefpceo/personal-portfolio-nextjs
...
<!-- ROADMAP -->
<!-- Optional section that can be used in the CHANGELOG.md as well as here -->
## Roadmap
...
See the [open issues](https://github.com/marefpceo/personal-portfolio-nextjs/issues) for a full list of proposed features (and known issues).
